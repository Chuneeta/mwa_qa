...
class TestCalMetrics(unittest.TestCase):
	...
	def test_variance_for_tilepair(self):
		m = cm.CalMetrics(calfile, metafits = metafits)
		variance = m.variance_for_tilepair((102, 104))
		self.assertEqual(variance.shape, (1, 1, 4))
		np.testing.assert_almost_equal(variance[0, 0, :], np.array([6.15063689e-02, 6.10921185e-06, 1.24056403e-05, 8.76188245e-02]), decimal = 6)
	...
	def test_variance_for_baselines_less_than(self):
		...
		self.assertEqual(bls, [(23, 21), (22, 21), (27, 26), (27, 43), (27, 41), (26, 25), (25, 43), (14, 36), (13, 12), (17, 16), (17, 15), (94, 47), (84, 83), (38, 37), (37, 42), (44, 45), (43, 41), (42, 41), (42, 45), (47, 45), (64, 63), (64, 66), (64, 65)])
		self.assertEqual(variances.shape, (1, len(bls), 4))
		np.testing.assert_almost_equal(variances[0, 0, :], np.array([1.69654699e-02, 8.44322446e-06, 1.13070715e-05, 2.04571904e-02]), decimal = 6)

	def test_skewness_across_baselines(self):
		m = cm.CalMetrics(calfile, metafits = metafits)
		skewness = m.skewness_across_baselines(10)
		np.testing.assert_almost_equal(skewness, np.array([[1.39739935, 1.1925527 , 0.08251331, 1.06225206]]))
