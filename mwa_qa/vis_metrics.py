...
class VisMetrics(object):
    ...
    def run_metrics(self):
        ...
        mavg_auto_rms = np.nanmean(avg_auto_rms, axis=0)
        vavg_auto_rms = np.nanvar(avg_auto_rms, axis=0)
        ...
        for p in ['XX', 'YY']:
            self.metrics['AUTOS'][p]['MEAN_RMS_AMPS'] = mavg_auto_rms[pol_dict[p]]
            self.metrics['AUTOS'][p]['VAR_RMS_AMPS'] = vavg_auto_rms[pol_dict[p]]
