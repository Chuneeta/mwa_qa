...
ax.semilogy(np.arange(len(obsids)), rms_all_sxx, '.',
            color='indianred', linewidth=2, label='XX')
ax.semilogy(np.arange(len(obsids)), rms_all_syy, '.',
            color='dodgerblue', linewidth=2, label='YY')
#ax.set_ylim(3e-2, max_rms + 1)
ax.legend(loc='upper right', ncol=2)
ax.grid(ls='dotted')
ax.set_title('({} x {})'.format(imsize[0], imsize[1]), size=13)
ax = fig.add_subplot(3, 2, 2)
ax.semilogy(np.arange(len(obsids)), rms_box_sxx, '.',
            color='indianred', linewidth=2, label='XX')
ax.semilogy(np.arange(len(obsids)), rms_box_syy, '.',
            color='dodgerblue', linewidth=2, label='YY')
...
ax.semilogy(np.arange(len(obsids)), rms_all_sv, '.',
            color='olivedrab', linewidth=2, label='V')
#ax.set_ylim(-0.5, max_rms_sv + 1)
ax.legend(loc='upper right')
ax.grid(ls='dotted')
ax = fig.add_subplot(3, 2, 4)
ax.semilogy(np.arange(len(obsids)), rms_box_sv, '.',
            color='olivedrab', linewidth=2, label='V')
#ax.set_ylim(-0.5, max_rms_sv + 1)
ax.legend(loc='upper right')
ax.grid(ls='dotted')
...
ax = fig.add_subplot(3, 2, 1)
ax.semilogy(pks_pflux_sxx, '.', color='indianred', linewidth=2, label='XX')
ax.semilogy(pks_pflux_syy, '.', color='dodgerblue', linewidth=2, label='YY')
#ax.set_ylim(-1, max_pks + 3)
ax.legend(loc='upper right', ncol=2)
ax.grid(ls='dotted')
ax.set_title('PEAK', size=13)
ax = fig.add_subplot(3, 2, 2)
ax.semilogy(pks_tflux_sxx, '.', color='indianred', linewidth=2, label='XX')
ax.semilogy(pks_tflux_syy, '.', color='dodgerblue', linewidth=2, label='YY')
#ax.set_ylim(-1, max_pks + 3)
ax.legend(loc='upper right', ncol=2)
ax.grid(ls='dotted')
...
ax.grid(ls='dotted')
ax = fig.add_subplot(3, 2, 3)
ax.semilogy(pks_pflux_sv, '.', color='olivedrab', linewidth=2, label='V')
#ax.set_ylim(-1, max_pks_sv + 3)
ax.legend(loc='upper right')
ax.grid(ls='dotted')
ax = fig.add_subplot(3, 2, 4)
ax.semilogy(pks_tflux_sv, '.', color='olivedrab', linewidth=2, label='V')
#ax.set_ylim(-1, max_pks_sv + 3)
ax.legend(loc='upper right')
ax.grid(ls='dotted')
ax = fig.add_subplot(3, 2, 5)
